...
var LandingRouterActivate = /** @class */ (function () {
    function LandingRouterActivate(router) {
        this.router = router;
    }
    LandingRouterActivate.prototype.canActivate = function () {
        if (localStorage.getItem("access_token") != null) {
